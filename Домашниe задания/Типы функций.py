...
food.extend('ХОЛ')                  #(.extend) добавление в основной список каждого символа по отдельности
print(food)
r = food.pop(4)                     #(.pop) удаляет ключ сохраняя его значение
print(r)
...
r2 = {'Anna': 9091788,'Anton': 7873436754,'Sasha': 3452132324} #(тип dict()) - (ключ : значение) только фигурные скобки
...
t = r2.pop('Anna')                                                #(.pop) удаляет ключ сохраняя его значение
print(r2)
print(t)
